...
- Do NOT lead with a discount or repeat the same coupon across multiple emails.
- Do NOT use fake stock counts, fabricated "price increasing" threats, or countdown timers that reset on reload; a real code expiry ("expires in 48 hours") is fine, a fake one is not.
- Do NOT send more than three emails or stack incentives until the cart "converts at any cost."
